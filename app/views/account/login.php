<article class="typo wrapper-padding">
    ...
    <form action="" method="POST">
        ...
        <small>don't have an account? <a href="<?php echo url('/account/register'); ?>" class="highlight">Get one &rarr;</a></small>
    </form>
    ...
    <?php if ($passport = config('passport')): ?>
        <p>
            ...
            <?php if (isset($passport['weibo'])): ?>
                <a href="<?php echo url('/login/weibo'); ?>" class=""><i class="font font-sina-weibo"></i> Weibo</a>
            <?php endif; ?>
